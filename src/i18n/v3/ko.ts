...
export const ko: T = {
  ...
  about: {
    ...
    h2mid: '트리트먼트의 목표는 이걸',
    h2em2: '이해하는 것.',
    body: '저는 단순한 코스메틱 시술사 이상입니다. 당신의 피부가 진정으로 필요로 하는 것이 무엇인지 이해하고, 장기적으로 건강과 광채를 유지할 수 있는 솔루션을 찾는 것이 저의 목표입니다. 당신의 피부는 생각보다 훨씬 많은 것을 이앺기해 줍니다.',
  ...
  contact: {
    ...
    items: [
      { icon: 'M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z M15 11a3 3 0 11-6 0 3 3 0 016 0z', label: '1126 Budapest, Dolgos utca 2. – 6B 계단동' },
