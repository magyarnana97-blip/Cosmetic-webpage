export const hu = {
  ...
  contact: {
    ...
    fields: [
      { id: 'name',    type: 'text',     label: 'Neved',         placeholder: 'Pl. Kovács Anna', required: true },
      { id: 'email',   type: 'email',    label: 'E-mail címed',  placeholder: 'anna@example.com', required: true },
      { id: 'message', type: 'textarea', label: 'Üzeneted',      placeholder: 'Miben segíthetek?', required: true },
    ],
    submit: 'Küldés',
